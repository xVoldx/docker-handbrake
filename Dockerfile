...
RUN wget http://mirrors.edge.kernel.org/ubuntu/pool/universe/m/meson/meson_0.45.1-2ubuntu0.18.04.2_all.deb
RUN apt install ./meson_0.45.1-2ubuntu0.18.04.2_all.deb -y
